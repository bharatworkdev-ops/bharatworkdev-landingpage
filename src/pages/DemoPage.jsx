...
const DemoPage = () => {
  return (
    <div className="min-h-screen bg-screen text-text-primary font-sans overflow-x-hidden selection:bg-action/30 selection:text-action pt-20 flex flex-col justify-between">
      <SEO 
        title="Interactive Crew Simulator | BharatWork"
        description="Try our interactive worker matching crew simulator. Experience how BharatWork matches verified workers in under 10 minutes."
      />
